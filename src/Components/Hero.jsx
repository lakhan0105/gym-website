...
function Hero() {
  ...
  return (
    <section
      className={`relative bg-no-repeat bg-center h-[calc(100vh-60px)] md:h-[calc(100vh-100px)] bg-cover`}
    >
      {/* overlay layer */}
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[40%] bg-gradient-to-t from-[#333333] md:from-[#000000d8] to-transparent z-20"></div>
      <div className="absolute bottom-0 left-0 right-0 h-[18%] bg-gradient-to-t from-[#333333] md:from-[#000000d8] to-transparent z-20 opacity-80"></div>
